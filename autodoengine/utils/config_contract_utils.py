...
LEGACY_TO_CHINESE_KEY_MAP: dict[str, str] = {
    ...
    "enabled_nodes": "启用节点",
    "gate_mode": "闸门模式",
    "ea_auto_audit_mode": "EA自动审计模式",
    "ea_auto_audit_policy": "EA自动审计策略",
    "ea_auto_audit_fail_action": "EA自动审计失败动作",
    "ea_auto_audit_model": "EA自动审计模型",
...
LEGACY_TO_CHINESE_VALUE_MAP_BY_KEY: dict[str, dict[str, str]] = {
    ...
    "ea_auto_audit_mode": {"auto": "自动", "on": "开启", "off": "关闭"},
    "ea_auto_audit_policy": {"llm_decide": "LLM裁决", "continue": "自动放行", "fail": "直接失败"},
    "ea_auto_audit_fail_action": {"fail": "标记失败", "blocked": "保持阻断", "continue": "继续执行"},
    ...
    "node_type": {"start": "开始", "process": "处理", "decision": "决策", "end": "结束", "generic": "通用"},
}
...
CHINESE_TO_LEGACY_VALUE_MAP_BY_KEY.setdefault("intervention_condition", {}).update(
    {
